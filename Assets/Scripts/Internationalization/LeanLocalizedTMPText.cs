...
namespace Lean.Localization
{
	...
	[HelpURL(LeanLocalization.HelpUrlPrefix + "LeanLocalizedTMPText")]
	[AddComponentMenu(LeanLocalization.ComponentPathPrefix + "Localized TMP Text")]
	public class LeanLocalizedTMPText : LeanLocalizedBehaviour
	{
