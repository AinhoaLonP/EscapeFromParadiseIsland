...
{
    /// <summary>
    /// Clase que representa la acción secundaria de la clase "Teach"
    /// . Implementa a <see cref="Assets.Scripts.Actions.BasePasiveAction" />
    /// </summary>
    /// <seealso cref="Assets.Scripts.Actions.BasePasiveAction" />
    public class LearnAction : BasePasiveAction
    {
        /// <summary>
        /// Nombre del objeto al que deben dirigirse para realizar una acción
        /// </summary>
        public override string DestinationName { get => "StudentPosition"; set { } }
        /// <summary>
        /// Nombre de la acción en el Animator
        /// </summary>
        public override string ActionName { get => "learn"; set { } }
        /// <summary>
        /// Lugar hacia el que el personaje debe mirar
        /// </summary>
        public override string WhereToLookAt { get => "TeacherPosition"; set { } }
    }
}
